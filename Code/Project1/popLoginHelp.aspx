<%@ Page Language="vb" AutoEventWireup="false" Inherits="BGO.BluegreenOnline.popLoginHelp" Codebehind="popLoginHelp.aspx.vb" %>
...
<meta charset="UTF-8">
<title>Sign-in Help | Bluegreen Owner</title>
...
<style>
	.site-content.cover-image { background-image: url( 'https://s7.bluegreenvacations.com/is/image/BGV/bgo-homepage-wildernessclub-horse-back-riding?$bgv-hero-home$' );}
</style>
</head>
<body>
				...
				<div class="col-xs-12 col-md-7 col-lg-6">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<h1 class="h1 color-primary text-lowercase"><strong>Sign-in</strong> Help</h1>
							<p><strong class="font-size-18 font-fancy">How do I sign in?</strong>
								<br>If you have already enrolled in Bluegreen Online, enter your email address and password in the input fields provided. You should use the email address and password on file with Bluegreen.</p>
							<p>If you have not enrolled in Bluegreen Online, you can register now in a few easy steps.</p>

							<p><strong class="font-size-18 font-fancy">Have you recently upgraded your Vacation Points?</strong>
								<br>If you have, you may have been assigned a new owner number and will need to enroll the new account. You should use your email address on file with Bluegreen and a password DIFFERENT from the one you used when you first enrolled. If you cannot sign in and you don't know your new owner number, please call Owner Services at 800.456.CLUB (2582) for assistance.</p>

							<p><strong class="font-size-18 font-fancy">Has your email address changed since you last signed in?</strong>
								<br>If it has, and it has not been updated in our system, you should use your old email address to sign in, then go to My Account to update it (see below).</p>

							<p><strong class="font-size-18 font-fancy">Change your email address or password</strong>
								<br>You can change your email address or password at any time. Once you have signed in, go to the My Account page. Scroll to the last line in the Contact Information section, enter your new email address then UPDATE your changes. The link to change your password is directly below the email field.</p>

							<p><strong class="font-size-18 font-fancy">Remember me</strong>
								<br>Check this box if you want <a href="http://bluegreenowner.com/default.aspx">Bluegreen Vacations</a> to remember your email address for future visits. For security purposes, you will still need to enter your password.</p>

							<p><strong class="font-size-18 font-fancy">Passwords</strong>
								<br>To ensure your privacy, passwords must be a combination of six to ten letters AND numbers. Also, passwords are case-sensitive. Be sure to enter your password exactly as you created it. Be careful when typing upper and lower case letters, and make sure your Caps Lock key is not on.</p>
		...
		<div class="row" itemscope itemtype="https://schema.org/WPSideBar">
			<div class="col-xs-12">
				<div class="copyright">
					...
					<p class="text-uppercase"><img src="https://s7.bluegreenvacations.com/is/image/BGV/equal-housing-logo-black?$png-alpha$&amp;op_colorize=999999&amp;wid=36" class="pull-right logo-eho" alt="Equal Housing Opportunity"><strong>This advertising material is being used for the purpose of soliciting the sale of timeshare interests.</strong>
						<br><strong>This advertising material is being used for the purpose of soliciting sales of a vacation ownership plan.</strong>
						<br><strong>This advertising material is being used for the purpose of soliciting the sale of time-share property or interests in time-share property.</strong></p>
