...
namespace BGSitecore.Models.OwnerService.PointBalanceListResponse
{
    ...
    public class VacationClubPoint
    {
        ...
        public DateTime StartDate { get; set; }     //manually changed
        public DateTime EndDate { get; set; }       //manually changed
    ...
    public class PointBalanceListResponse
    {
        public string Identifier { get; set; }
